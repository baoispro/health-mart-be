...
export class UserController {
    ...
    @ApiResponse({ status: 200, description: 'Thông tin tất cả users', type: BaseResponseDto})
    ...
    @ApiResponse({ status: 200, description: 'Thông tin user', type: BaseResponseDto})
    ...
    @ApiResponse({ status: 201, description: 'Tạo thành công', type: BaseResponseDto})
    ...
    updateUser(@Param('id') id: number, @Body() updateUserRequest: UpdateUserRequest) {
