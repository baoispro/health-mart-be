import { Controller, Get, Post, Body, Inject, BadRequestException, Param, Delete, Put } from "@nestjs/common";
...
export class OrderController {
  ...
  @ApiResponse({ status: 200, description: 'Thông tin đơn hàng', type: BaseResponseDto})
  ...
  updateOrder(@Param('id') id: number, @Body() updateOrderRequest: UpdateOrderRequest) {
